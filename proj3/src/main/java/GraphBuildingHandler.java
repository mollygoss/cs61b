...
//            System.out.println("Beginning a way...");
            ...
            GraphDB.Node currentnode = g.nodemap.get(id);
            GraphDB.Way currentway = g.ways.getLast();

            if (!currentway.waynodes.isEmpty()) {
                GraphDB.Node adjacent = currentway.waynodes.getLast();
                GraphDB.Edge edge = new GraphDB.Edge(adjacent, currentnode);
                currentway.wayedges.add(edge);
            }

            currentway.waynodes.add(currentnode);
            ...
            if (k.equals("maxspeed")) {
                ...
                String max = attributes.getValue("v");
                ...
                String itslit = attributes.getValue("v");
            }
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
            ...
            last.name = attributes.getValue("v");
...
//            System.out.println("Finishing a way...");
            ...
            if (currentway.isvalid) {
                for (GraphDB.Edge edge: currentway.wayedges) {
                    g.addEdge(edge);
                }
            }
        }
